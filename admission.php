            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light" >
             ...
             <br>
                ...
                <div class="container" style="background-color:#ebebe0">
                            <form id="f" class="form-control form-control-sm shadow-lg" style="margin-top:20px;background:#c3e8cb;" method="post" action="admission.php">
