...
?>
 <?php
                              ...
                              $lupdate = "";
							    ...
							    {
								      $sr = $_GET['sr'];
								      $fetch1 = "SELECT * FROM courses WHERE sr = '$sr'";
								      $query = mysqli_query($conn,$fetch1);
								      $fetch2 = mysqli_fetch_assoc($query);
								  
                                      $title = $fetch2['title'];
                                      $hstitle = $fetch2['hstitle'];
                                      $desc = $fetch2['desc'];
						              $h1 = $fetch2['h1'];
						              $h2 = $fetch2['h2'];
						              $h3 = $fetch2['h3'];
                               ...
                               if(isset($_POST['update']))
                               {
                                ...
                                try
                                {
                                    $query = "UPDATE `courses` SET `title` = '$title', `hstitle` = '$hmtitle',`fees` = '$fee', `desc` = '$desc', `h1` = '$h1', `h2` = '$h2', `h3` = '$h3', `h4` = '$h4', `duration` = '$duration', `lupdate` = '$lupdate' WHERE `sr` = '$sr'";
                                    $result = mysqli_query($conn,$query);
                                    echo "<script type='text/javascript'>
                                                        alert('Course Is Successfully Updated...........');
            ...
            <div class= "container-fluid">
             ...
             <div class="container-fluid">
                    ...
                    <div class="card text-center bg-secondary text-white">
                     ...
                     <form class="row g-3" method="post" action="courses_insert2.php">
                              <div class="col-md-6">
                                <label for="inputEmail4" class="form-label">Title Of Course</label>
                                <input type="text" class="form-control" id="inputEmail4" name="tcourse" value="<?php echo $title; ?>" placeholder="Software Testing">
                              </div>
                               ...
                               <?php
									  ...
									  {
						      ?>
								            <input type="hidden" name="sr" value=" <?php echo $_GET['sr']; ?>" >
                             ...
                             <?php 
                              ...
                              <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" id="inputPassword4" name="fees" value="<?php echo $fees; ?>" placeholder="3000">
                              </div>

                               <div class="col-12">
                                <label for="inputAddress" class="form-label">Brief Description For Home Page</label>
                                <input type="text" class="form-control" id="inputAddress1" name="ddcourse" value="<?php echo $hstitle; ?>" placeholder="Brief Discription">
                              </div>

                              <div class="col-12">
                                <label for="inputAddress" class="form-label">Description Of Course</label>
                                <input type="text" class="form-control" id="inputAddress" name="dcourse" value="<?php echo $desc; ?>" placeholder="Brief Discription">
                              </div>

                              <div class="col-md-2">
                                <label for="inputZip" class="form-label">Duration Of Course</label>
                                <input type="text" class="form-control" id="inputZip0" name="ducourse" value="<?php echo $duration; ?>" placeholder="3 Month or 3 Year">
                              </div>
                              
                              <div class="col-md-2">
                                <label for="inputZip" class="form-label">Highlight Point</label>
                                <input type="text" class="form-control" id="inputZip1" name="hcourse1" value="<?php echo $h1; ?>" placeholder="abc">
                              </div>
 
                              <div class="col-md-2">
                                <label for="inputZip" class="form-label">Highlight Point</label>
                                <input type="text" class="form-control" id="inputZip2" name="hcourse2" value="<?php echo $h2; ?>" placeholder="abc">
                              </div>

                              <div class="col-md-2">
                                <label for="inputZip" class="form-label">Highlight Point</label>
                                <input type="text" class="form-control" id="inputZip3" name="hcourse3" value="<?php echo $h3; ?>" placeholder="abc">
                              </div>

                               <div class="col-md-2">
                                <label for="inputZip" class="form-label">Highlight Point</label>
                                <input type="text" class="form-control" id="inputZip4" name="hcourse4" value="<?php echo $h4; ?>" placeholder="abc">
                              </div>

                              <div class="col-md-2">
                                <label for="inputZip" class="form-label">Last Update</label>
                                <input type="text" class="form-control" id="inputZip5" name="lupdate" value="<?php echo $lupdate; ?>" placeholder="3 month, 3 min,s">
                              </div>

                              <div class="col-12">
                                <button type="submit" name="update" onclick="run()" class="btn btn-primary">Update Course</button>
                              </div>
                     </form>
